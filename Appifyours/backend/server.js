...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/fft_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '695f649f4178f15ea2cb0831',
      shopName: 'fft',
...
app.listen(PORT, () => {
  console.log(`fft Backend Server running on port ${PORT}`);
});
